...
class walkerNavMenu extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		if ($depth == 1) {
			$output .= "\n$indent<ul role=\"sub-menu\" data-depth=".$depth." class=\"uk-nav-sub\">\n";
        } else {
            $output .= "\n$indent<div uk-dropdown>\n<ul role=\"menu\" data-depth=".$depth." class=\"uk-nav-default uk-nav-parent-icon\" uk-nav>\n";
        }
	}
