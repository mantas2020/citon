...
function custom_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'custom_category_count' ) ) ) {
		...
		set_transient( 'custom_category_count', $all_the_cool_cats );
	}
...
function custom_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'custom_category_count' );
}
...
if ( ! function_exists( 'custom_excerpt_more' ) && ! is_admin() ) :
/**
