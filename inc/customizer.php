...
function custom_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'featured_content_layout', array(
		'default'           => 'grid',
		'sanitize_callback' => 'custom_sanitize_layout',
	) );
 ...
 */
function custom_sanitize_layout( $layout ) {
...
function custom_customize_preview_js() {
	wp_enqueue_script( 'custom_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20131205', true );
}
 ...
 * @since Twenty Fourteen 1.0
 */
function custom_contextual_help() {
...
add_action( 'admin_head-themes.php', 'custom_contextual_help' );
add_action( 'admin_head-edit.php',   'custom_contextual_help' );
