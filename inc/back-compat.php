...
function custom_switch_theme() {
	...
	add_action( 'admin_notices', 'custom_upgrade_notice' );
}
 ...
 * @since Twenty Fourteen 1.0
 */
function custom_upgrade_notice() {
...
add_action( 'load-customize.php', 'custom_customize' );
...
add_action( 'template_redirect', 'custom_preview' );
